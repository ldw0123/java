// MouseAdapter를 상속받아 마우스 리스너 작성
import java.awt.*;
import java.awt.event.*;
import javax.swing.*;

public class MouseAdapterEx_040 extends JFrame	{
	private JLabel la = new JLabel("Hello"); 	// "Hello" 문자열을 출력하기 위한 레이블 컴포넌트
	
	public MouseAdapterEx_040() {
	...
	class MyMouseAdapter extends MouseAdapter {	// Mouse 리스너 구현
